...
class Menu extends Phaser.Scene {
  constructor() {
    ...
    this.sdk = createGameSDK('tommyJumping')
  }
  ...
  create() {
    ...
    this.pointsText = this.add
      .bitmapText(this.scale.width / 2, this.scale.height - 100, 'pixelFont', 'POINTS ' + this.points)
      .setDepth(2)
      .setOrigin(0.5)

    this.bestPointsText = this.add
      .bitmapText(this.scale.width / 2, this.scale.height - 80, 'pixelFont', 'BEST ' + this.betsPoints)
      .setDepth(2)
      .setOrigin(0.5)
